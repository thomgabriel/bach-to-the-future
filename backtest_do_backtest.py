...
short_target = actualPrice * (1-0.003)
short_stop = actualPrice * (1+0.003)

long_qtd = round(actualPrice * margin * leverage * 0.8)

long_entry = actualPrice
long_target =  actualPrice * (1+0.003)
long_stop = actualPrice * (1-0.003)
...
# margin = margin + ((long_qtd/long_entry) - (long_qtd/long_target)) - ((long_qtd/long_entry) * maker_fee) - ((long_qtd/long_target) * maker_fee)
# print(margin)
# print((long_qtd/long_entry))
# print((long_qtd/long_target))
